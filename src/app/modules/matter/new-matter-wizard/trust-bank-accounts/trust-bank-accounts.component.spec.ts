...
import { TrustBankAccountsComponent } from './trust-bank-accounts.component';
...
describe('TrustBankAccountsComponent', () => {
  let component: TrustBankAccountsComponent;
  let usioService : UsioService;
  let fixture: ComponentFixture<TrustBankAccountsComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TrustBankAccountsComponent);
  ...
  it('getUsioTenantTrustBankAccounts called in ngOnInIt', () => {
    ...
    spyOn(usioService, 'v1UsioGetUsioMatterBankAccountsGet').and.returnValue(of(res as any));
  ...
  it('originalOfficeBankList list length equals to 1', () => {
    component.opratingAccountReadOnlyFlag = true;
  });
