...
import { EditChargesPotentialClientComponent } from './edit-charges-potential-client.component';
...
describe('EditChargesPotentialClientComponent', () => {
  let component: EditChargesPotentialClientComponent;
  let fixture: ComponentFixture<EditChargesPotentialClientComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      .compileComponents()
      .then(() => {
        fixture = TestBed.createComponent(EditChargesPotentialClientComponent);
