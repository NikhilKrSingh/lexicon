...
import {SetDemoComponent } from '../set-demo/set-demo.component';
import { ConfirmDemoModelComponent } from './confirm-demo-model/confirm-demo-model.component';
...
@Component({
  selector: 'app-create-demo-table',
  templateUrl: './create-demo-table.component.html',
  styleUrls: ['./create-demo-table.component.scss'],
  encapsulation: ViewEncapsulation.Emulated
})
export class CreateDemoTableComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.router.url.includes('/firm/view-demo-table')) {
      this.viewMode = true;
    }
  ...
  setRate(className, winClass) {
    let modalRef = this.modalService.open(SetDemoComponent, {
      size: className,
