...
@Component({
  selector: 'app-fixed-fee-write-down',
  templateUrl: './write-down.component.html',
  encapsulation: ViewEncapsulation.Emulated,
})
export class FixedFeeWriteDownComponent implements OnInit {
  add = true;
  edit = true;
  service: any;
  ...
  ngOnInit() {
    this.rateAmount = this.service.rateAmount - this.writedownAmount;
