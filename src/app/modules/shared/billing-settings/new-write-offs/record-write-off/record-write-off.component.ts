...
export class RecordWriteOffComponent implements OnInit {
  ...
  public isPotentialClient: boolean;
            ...
            if (res) {
              this.toastr.showSuccess(
                selectedTiming && selectedTiming.code === 'INCLUDE_IN_NEXT_BILL'
                  ...
                  : (this.isPotentialClient ? this.error_data.write_of_record_added_bill_now_pc : this.error_data.write_of_record_added_bill_now)
              );
