...
@Component({
  selector: 'app-add-client-event',
  templateUrl: './add-client-event.component.html',
  styleUrls: ['./add-client-event.component.scss'],
  encapsulation: ViewEncapsulation.Emulated
})
export class AddClientEventComponent implements OnInit, OnDestroy {
  ...
  public submittedRecurringEvent: boolean = false;
  ...
  isInviteeSearchLoading: boolean = false;
  ...
  public save() {
    ...
    if (this.eventForm.valid) {
      ...
      if (data.recurringType) {
        if (!this.submittedRecurringEvent) {
          this.saveRecuringEvent();
        }
  ...
  public saveRecuringEvent() {
    this.submitted = true;
    this.submittedRecurringEvent = true;
